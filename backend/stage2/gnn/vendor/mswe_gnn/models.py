"""Vendored verbatim from RBTV1/mSWE-GNN's models/models.py (MIT License,
Copyright (c) 2024 Roberto Bentivoglio), fetched directly from
github.com/RBTV1/mSWE-GNN in-session (2026-08-20). Byte-identical to the
original file -- no lines changed. See LICENSE in this directory.
"""
